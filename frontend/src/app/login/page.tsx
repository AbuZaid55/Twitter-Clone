  ...
  return (
    <div className='flex items-center justify-center flex-col h-screen w-full'>
      ...
      <form className='flex flex-col gap-2'>
        ...
        <button className="bg-blue-500 font-bold px-20 py-3 rounded-full mt-5">Log In</button>
      ...
      <p className='mt-3'>Don't have an account? <Link className='text-blue-400' href="/signup">Sign Up</Link></p>
    </div>
  )
}
