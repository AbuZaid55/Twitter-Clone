...
export type LogInQuery = { __typename?: 'Query', logIn?: { __typename?: 'Response', status: number, message: string, user?: { __typename?: 'User', id: string, name: string, email: string, avatar?: string | null, createdAt: string } | null } | null };
